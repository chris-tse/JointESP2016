...
<html lang="en">
	<head>
        ...
        <title>Registration Form - ESP Conference 2016</title>
        ...
        <main class="container">
            <div class="row">
                <article class="col-sm-12">
                    ...
                    $onedayselect = '';
                    if(isset($_POST['onedayselect'])){


                        if(!empty($_POST['onedayselect'])) {

                            $onedayselect = $_POST['onedayselect'];

                        }
                    }
                    if($feetype == 'Regular 1-Day' || $feetype == 'Student 1-Day') {
                        if(!isset($_POST['onedayselect'])) {
                            exit("<h2>An error has occurred</h2><p>You have selected a 1-Day Registration, but did not specify a day. Please return to the previous page and select which day you would like to register for.");
                        }
                    }

                    $outputfile = "latereg/" . $famname . $current_date . ".txt";
                    ...
                    $text = "Name: " . $fname . " " . $famname . PHP_EOL . "Email: " . $email . PHP_EOL . "Department: " . $dept . PHP_EOL . "University/Institute: " . $uniinst . PHP_EOL . "Professional Title: " . $ptitle . PHP_EOL . "Mailing Address: " . PHP_EOL . $mailaddress . PHP_EOL . "Phone: " . $phone . PHP_EOL . "Fax: " . $fax . PHP_EOL . "Presentation Number: " . $pnum . PHP_EOL . "Fee Type: " . $feetype . PHP_EOL . "1 Day Selection: " . $onedayselect;
